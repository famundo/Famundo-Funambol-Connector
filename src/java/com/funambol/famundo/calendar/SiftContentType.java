...
public class SiftContentType extends FamundoContentType {
	public static final long serialVersionUID = 1;
	
	protected static final FunambolLogger _log = FunambolLoggerFactory.getLogger(Def.LOGGER_NAME);
	
	public SiftContentType()
	{
		super("SIF-T", "text/x-s4j-sift", "1.0");
	}
	...
	throws SyncSourceException
	{
		...
		return calendar2sift(c, ctx).getBytes();
	}
	...
	throws SyncSourceException
	{
        ...
        catch (Exception e)
        {
            ...
            throw new SyncSourceException("Error converting SIF-T to Calendar.", e);
        }
	}
	...
	private String calendar2sift(Calendar calendar, FamundoContext ctx)
	throws SyncSourceException
	{
		try
		{
			BaseConverter c2xml = new TaskToSIFT(ctx.getDeviceTimezone(), getCharset(ctx));
			return c2xml.convert(calendar.getTask());
		}
        catch (Exception e)
        {
